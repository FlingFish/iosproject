...
@property (nonatomic, assign) URBAlertAnimation animationType; // 动画类型
...
#define kURBAlertBackgroundRadius 10.0 // 半径
#define kURBAlertFrameInset 7.0 // 边框宽度
#define kURBAlertPadding 10.0 // Alert的间隙
#define kURBAlertButtonPadding 6.0 // 按钮的间隙
#define kURBAlertButtonHeight 44.0 // 按钮的高度
#define kURBAlertButtonOffset 66.5 // 按钮的偏移量
