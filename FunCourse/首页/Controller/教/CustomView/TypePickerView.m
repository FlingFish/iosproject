...
#define RGBColor(r, g, b)    [UIColor colorWithRed:(r)/255.f green:(g)/255.f blue:(b)/255.f alpha:0.9]

@interface TypePickerView ()<UITableViewDataSource, UITableViewDelegate>
...
{
    return [[self alloc] initWithPoint:point titles:titles images:images];
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.backgroundView.backgroundColor = RGBColor(245, 245, 245);
